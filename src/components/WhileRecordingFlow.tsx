...
interface WhileRecordingFlowProps {
  actionBlock: any;
  currentIndex: number;
  totalBlocks: number;
  onBack: () => void;
...
export function WhileRecordingFlow({
  actionBlock,
  currentIndex,
  totalBlocks,
  onBack,
  onComplete,
}: WhileRecordingFlowProps) {
    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="flex-shrink-0 border-b border-gray-200">
        <div className="px-4 py-4">
          ...
          <p className="text-[14px] text-gray-600 mt-1">While Loop</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <h3 className="text-[20px] text-gray-900 mb-2">While Loop Recording</h3>
          <p className="text-[16px] text-gray-600 mb-6">
            While loop recording flow is similar to conditional flow with condition builder + loop body recording.
          </p>
          <button
            onClick={onComplete}
